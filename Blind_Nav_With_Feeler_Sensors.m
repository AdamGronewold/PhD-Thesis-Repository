%--------------------------------------------------------------------------
% This code is a simulation environment to demonstrate autonomous navigation in 
% a cornfield using only tactile sensors for obstacle avoidance. The robot uses A-star
% to create a path directed toward predetermined waypoints, then uses pure pursuit to execute
% the planned path. Along the path the tactile sensors construct a map of the environment
% stored as a two dimensional list of points corresponding to plant locations. 

% This simulation includes code for joint state classification to determine contact with nearby plants,
% code for the true dynamic model of the sensor and the robot, code simulating sensor measurement 
...
v = VideoWriter('astar_pureprsuit_with_2_feelers', 'MPEG-4');                                                   
v.FrameRate = 25;
v.Quality = 100;
open(v);
